...
const applyMode = (isDarkMode) => {
    if (isDarkMode) {
        ...
        poem.style.backgroundImage = `url("./assets/img/pexels-lloyd-freeman-599375-1381786.jpg")`;
        ...
        welcomeTitle.style.background = `url("./assets/img/pexels-richard-wilson-1717169-13069707.jpg") repeat center`;
        welcomeTitle.style.backgroundClip = "text";
